...
from flask import request, render_template, current_app, redirect, url_for, session, jsonify, g, abort
...
def login():
    if request.method == 'GET':
        ...
        if user_id and is_admin:  # 管理员已登录, 直接重定向到后台首页
